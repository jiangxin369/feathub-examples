...
if __name__ == "__main__":
    ...
    purchase_events_source = FileSystemSource(
        ...
        path="hdfs://namenode:8020/tmp/spark-data/purchase_events.json",
        data_format="json",
    ...
    item_price_events_source = FileSystemSource(
        ...
        path="hdfs://namenode:8020/tmp/spark-data/item_price_events.json",
        data_format="json",
    ...
    hdfs_sink = FileSystemSink(
        path="hdfs://namenode:8020/tmp/spark-data/output.json", data_format="csv"
    )
